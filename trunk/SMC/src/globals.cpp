...
cPlayer *pPlayer __attribute__((aligned(32))) = NULL;
cLevel *pLevel __attribute__((aligned(32))) = NULL;
cOverWorld *pOverWorld __attribute__((aligned(32))) = NULL;
cMainMenu *pMenu __attribute__((aligned(32))) = NULL;

cAudio *pAudio __attribute__((aligned(32))) = NULL;
cPreferences *pPreferences __attribute__((aligned(32))) = NULL;
cMouseCursor *pMouseCursor __attribute__((aligned(32))) = NULL;
cLevelEditor *pLeveleditor __attribute__((aligned(32))) = NULL;
cSavegame *pSavegame __attribute__((aligned(32))) = NULL;
...
void Preload_images( void )
{
	...
	// The Fire Animation
	GetImage( "animation/fire_1/1.png" );
	GetImage( "animation/fire_1/2.png" );
	GetImage( "animation/fire_1/3.png" );
	GetImage( "animation/fire_1/4.png" );
}
