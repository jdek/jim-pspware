...
#define HINT_CONNECT "Specify the game server as address:port where "\
...
void client_create( void )
{
    ...
    gui_button_create(
        ...
        140, 24, client_close_connect_window, 0,0,0,0,0, "Cancel" );
    /* INFO */
    ...
    gui_button_create( dlg_chatroom, 330,448,70,24, 
        client_send_chatter, 0,0,0,0,0, "Send" );
    gui_button_create( dlg_chatroom, 400,448,70,24, 
...
void client_run( void )
{
	...
	sys_printf = printf;
	client_add_chatter( "Press 'Connect' to connect to a game server.", 1 );
