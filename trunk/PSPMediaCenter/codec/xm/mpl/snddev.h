...
typedef struct mpl__snd_mixer_s {
    ...
    int (*play_channel) (void *internal, int ch, int handle, float32 freq, float32 vol, float32 pan_lr, float32 pan_fb,
			 float64 pos, int dir);
...
int mpl__snd_mixer_play_channel(mpl__snd_mixer_t * mixer, int ch, int handle, float32 freq, float32 vol, float32 pan_lr,
