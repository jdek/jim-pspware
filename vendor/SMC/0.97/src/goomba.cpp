...
cGoomba :: cGoomba( double x, double y, int col /* = 0 */ ) : cEnemy( x, y )
{
	...
	if( color == 0 ) // Brown
	{
		images.push_back( GetImage( "enemy/goomba/brown/r.png" ) );
		images.push_back( GetImage( "enemy/goomba/brown/l.png" ) );
		images.push_back( GetImage( "enemy/goomba/brown/dead.png" ) );
		velx = 2.7;
		anispeed = 16;
	...
	{
		images.push_back( GetImage( "enemy/goomba/blue/r.png" ) );
		images.push_back( GetImage( "enemy/goomba/blue/l.png" ) );
		images.push_back( GetImage( "enemy/goomba/blue/dead.png" ) );
		velx = 4.5;
		anispeed = 12;
	}
	else
