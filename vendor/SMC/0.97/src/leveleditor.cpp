...
cLevelEditor :: cLevelEditor( void )
{
	...
	Item_scroller_left->image_default = GetImage( "game/leveleditor/arrow_left.png" );
	Item_scroller_left->image_hover = GetImage( "game/leveleditor/arrow_left_hover.png" );
	...
	Item_scroller_right->image_default = GetImage( "game/leveleditor/arrow_right.png" );
	Item_scroller_right->image_hover = GetImage( "game/leveleditor/arrow_right_hover.png" );
...
void cLevelEditor :: Load_Item_Menu( unsigned int menu_id )
{
	...
	{
		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Up" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/down.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Down" );
		
		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/right.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Right" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/left.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Left" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Middle" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Left up" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Right up" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/left_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left Down" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/right_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right Down" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/hill_left.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Hill Left" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/hill_right.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Hill Right" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/hill_left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Hill Left up" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/ground/hill_right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Hill Right up" );
		
		Sprite_type = new cSprite( GetImage( "ground/green_1/kplant.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Sprite_type->climbable = 1;
		Add_Item_Object( Sprite_type, "Climbing Plant" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/kplant_head.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant Head" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/plant_l.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant left" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/plant_m.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant middle" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/plant_r.png" ), 0, 0 );
		Sprite_type->massive = 0;
	...
	{
		// Blue
		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/right.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/left.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Middle" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Left up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Right up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/left_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_blue/right_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right down" );

		// Green
		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/right.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/left.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Middle" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Left up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Right up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/left_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_green/right_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right down" );

		// Grey
		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/right.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/left.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Middle" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Left up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Right up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/left_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_grey/right_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right down" );

		// Red
		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/right.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/left.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Middle" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/left_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Left up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/right_up.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Right up" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/left_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Left down" );

		Sprite_type = new cSprite( GetImage( "ground/plastic_1/screw_block_red/right_down.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Right down" );
	}
	else if( menu_id == MENU_JUNGLE_1 ) 
	{
		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/hill_up_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Yoshi Hill up" );

		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/rope_1_leftright.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Rope" );

		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/extra_1_red.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant Red" );

		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/extra_1_yellow.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant Yellow" );

		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/extra_1_blue.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant Blue" );

		Sprite_type = new cSprite( GetImage( "ground/yoshi_1/extra_1_green.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Plant Green" );

		Sprite_type = new cSprite( GetImage( "ground/jungle_1/berry_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Berry" );

		Sprite_type = new cSprite( GetImage( "ground/jungle_1/kplant.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Sprite_type->climbable = 1;
		Add_Item_Object( Sprite_type, "Climbing Plant" );

		Sprite_type = new cSprite( GetImage( "ground/jungle_1/beanstalk.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Beanstalk" );
	}
	else if( menu_id == MENU_GHOST_1 )
	{
		Sprite_type = new cSprite( GetImage( "ground/ghost_1/way_1_left.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Way left" );

		Sprite_type = new cSprite( GetImage( "ground/ghost_1/way_1_middle.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Way middle" );

		Sprite_type = new cSprite( GetImage( "ground/ghost_1/way_1_right.png" ), 0, 0 );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Way right" );
		
		Sprite_type = new cSprite( GetImage( "ground/ghost_1/lamp_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Lamp" );

		Sprite_type = new cSprite( GetImage( "ground/ghost_1/window_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Window" );
	}
	else if( menu_id == MENU_HEDGES_GREEN ) 
	{
		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/medium_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Hedge Med" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/medium_2.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Hedge Med" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/small_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Hedge Sm" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/small_2.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Hedge Sm" );

		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/big_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Hedge Big" );
		
		Sprite_type = new cSprite( GetImage( "ground/green_1/hedges/wild_medium.png" ), 0, 0 );
		Sprite_type->massive = 0;
	...
	{
		// The upward pipes
		Sprite_type = new cSprite( GetImage( "pipes/up/blue_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/up/blue_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue Med" );

		Sprite_type = new cSprite( GetImage( "pipes/up/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/up/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/up/grey_big_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Big" );

		Sprite_type = new cSprite( GetImage( "pipes/up/grey_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/up/yellow_big_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Big" );

		Sprite_type = new cSprite( GetImage( "pipes/up/yellow_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Med" );

		// The left pipes
		Sprite_type = new cSprite( GetImage( "pipes/left/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/left/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/left/grey_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Sm" );

		// The right pipes
		Sprite_type = new cSprite( GetImage( "pipes/right/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/right/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/right/grey_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Sm" );

		// The downward pipes
		Sprite_type = new cSprite( GetImage( "pipes/down/blue_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/down/blue_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue Med" );

		Sprite_type = new cSprite( GetImage( "pipes/down/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/down/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/down/grey_big_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Big" );

		Sprite_type = new cSprite( GetImage( "pipes/down/grey_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Grey Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/down/yellow_big_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Big" );

		Sprite_type = new cSprite( GetImage( "pipes/down/yellow_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Med" );

		// The leftright pipes
		Sprite_type = new cSprite( GetImage( "pipes/leftright/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/leftright/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/leftright/yellow_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Med" );
		
		// The updown pipes
		Sprite_type = new cSprite( GetImage( "pipes/updown/green_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Med" );

		Sprite_type = new cSprite( GetImage( "pipes/updown/green_small_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Sm" );

		Sprite_type = new cSprite( GetImage( "pipes/updown/yellow_medium_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Yellow Med" );
	}
	else if( menu_id == MENU_HILLS ) 
	{
		Sprite_type = new cSprite( GetImage( "hills/blue_1/1_big.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Blue Big" );

		Sprite_type = new cSprite( GetImage( "hills/blue_1/1_medium.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Blue Med" );

		Sprite_type = new cSprite( GetImage( "hills/light_blue_1/head.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue Head" );

		Sprite_type = new cSprite( GetImage( "hills/light_blue_1/middle.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Blue" );

		Sprite_type = new cSprite( GetImage( "hills/green_1/head.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green Head" );

		Sprite_type = new cSprite( GetImage( "hills/green_1/middle.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Green" );
	}
	else if( menu_id == MENU_BLOCKS ) 
	{
		Sprite_type = new cSprite( GetImage( "game/box/brown1_1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "default" );

		Sprite_type = new cSprite( GetImage( "blocks/stone/1.png" ), 0, 0 );
		Add_Item_Object( Sprite_type, "Stone" );

		Sprite_type = new cSprite( GetImage( "blocks/wood/1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Wood" );

		Sprite_type = new cSprite( GetImage( "game/box/white1_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
	...
	{
		Sprite_type = new cSprite( GetImage( "signs/default_1/1_ending.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Ending" );

		Sprite_type = new cSprite( GetImage( "signs/default_1/1_ending_big.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Ending Big" );

		Sprite_type = new cSprite( GetImage( "signs/yoshi/post.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Yoshi Post" );
	}
	else if( menu_id == MENU_CLOUDS ) 
	{
		Sprite_type = new cSprite( GetImage( "clouds/default_1/1_middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Cloud" );

		Sprite_type = new cSprite( GetImage( "clouds/default_1/2_big.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Cloud Big" );

		Sprite_type = new cSprite( GetImage( "clouds/default_1/2_small.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Cloud Sm" );

		Sprite_type = new cSprite( GetImage( "clouds/cloudy_1/middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Add_Item_Object( Sprite_type, "Cloud" );
	}
	else if( menu_id == MENU_EXTRA ) 
	{
		Sprite_type = new cSprite( GetImage( "slider/grey_1/slider_left.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Slider left" );


		Sprite_type = new cSprite( GetImage( "slider/grey_1/slider_middle.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Slider mid" );

		Sprite_type = new cSprite( GetImage( "slider/grey_1/slider_right.png" ), 0, 0 );
		Sprite_type->massive = 0;
		Sprite_type->halfmassive = 1;
		Add_Item_Object( Sprite_type, "Slider right" );

		Sprite_type = new cSprite( GetImage( "game/level/door_yellow_1.png" ), 0, 0 );
		Sprite_type->massive = 0;
	...
	else if( menu_id == MENU_SPECIAL ) 
	{
		...
		Add_Item_Object( Sprite_type, "Level Beam", GetImage( "game/leveleditor/special.png" ) );

		Sprite_type = new cLevelExit( 0, 0, LVLCHANGE_WARP );
		Sprite_type->massive = 1;
		Add_Item_Object( Sprite_type, "Level Warp", GetImage( "game/leveleditor/special.png" ) );

		Sprite_type = new cCloud( 0, 0 );
		Add_Item_Object( Sprite_type, "Moving Cloud" );

		Sprite_type = new cGoldPiece( 0, 0 );
		Add_Item_Object( Sprite_type, "Goldpiece", GetImage( "animation/goldpiece_1/3.png" ) );

		Sprite_type = new cMoon( 0, 0 );
		Add_Item_Object( Sprite_type, "Moon" );

		Sprite_type = new cEnemyStopper( 0, 0 );
		Add_Item_Object( Sprite_type, "Enemystopper", GetImage( "game/leveleditor/special.png" ) );
	}
	else
	{
