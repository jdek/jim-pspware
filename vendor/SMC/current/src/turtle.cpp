...
cTurtle :: cTurtle( double x, double y, unsigned int color ) : cEnemy( x, y )
{
	...
	if( color == 1 ) // Red
	{
		images.push_back( GetImage( "enemy/turtle/red/shell_m1r.png" ) );	// Red Shell Standard
		images.push_back( GetImage( "enemy/turtle/red/shell_m2r.png" ) );	// Red Shell Blinks
		images.push_back( GetImage( "enemy/turtle/red/turtle_l1r.png" ) );	// Red Turtle walking left 1
		images.push_back( GetImage( "enemy/turtle/red/turtle_l2r.png" ) );	// Red Turtle walking left 2
		images.push_back( GetImage( "enemy/turtle/red/turtle_r1r.png" ) );	// Red Turtle walking right 1
		images.push_back( GetImage( "enemy/turtle/red/turtle_r2r.png" ) );	// Red Turtle walking right 2
		images.push_back( GetImage( "enemy/turtle/red/shell_m3r.png" ) );	// Red Shell Back
		images.push_back( GetImage( "enemy/turtle/red/turtle_m1r.png" ) );	// Red Shell Standard
		images.push_back( GetImage( "enemy/turtle/red/turtle_m2r.png" ) );	// Red Shell Blinks
		images.push_back( GetImage( "enemy/turtle/red/shell_lr.png" ) );	// Red Shell moving right
		images.push_back( GetImage( "enemy/turtle/red/shell_rr.png" ) );	// Red Shell moving left
		images.push_back( GetImage( "enemy/turtle/red/shell_d.png" ) );		// Red Shell dead
	}
