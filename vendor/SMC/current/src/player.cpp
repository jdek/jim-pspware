...
void cPlayer :: LoadImages( bool preload )
{
	...
	if( maryo_type == MARYO_SMALL )
	{
		/********************* Small **************************/
		// standing
		images.push_back( GetImage( "maryo/small_left.png" ) );
		images.push_back( GetImage( "maryo/small_right.png" ) );
		// running
		images.push_back( GetImage( "maryo/small_run_left.png" ) );
		images.push_back( GetImage( "maryo/small_run_right.png" ) );
		// falling
		images.push_back( GetImage( "maryo/small_fall_left.png" ) );
		images.push_back( GetImage( "maryo/small_fall_right.png" ) );
		// jumping
		images.push_back( GetImage( "maryo/small_jump_left.png" ) );
		images.push_back( GetImage( "maryo/small_jump_right.png" ) );
		// dead
		images.push_back( GetImage( "maryo/small_dead_left.png" ) );
		images.push_back( GetImage( "maryo/small_dead_right.png" ) );
		// ducked
		images.push_back( GetImage( "maryo/small_duck_left.png" ) );
		images.push_back( GetImage( "maryo/small_duck_right.png" ) );
		// running 2
		images.push_back( NULL );
		images.push_back( NULL );
		// climbing
		images.push_back( GetImage( "maryo/small_climb_left.png" ) );
		images.push_back( GetImage( "maryo/small_climb_right.png" ) );
		/****************************************************/
	}
	else if( maryo_type == MARYO_BIG )
	{
		/********************* Big ****************************/
		// standing
		images.push_back( GetImage( "maryo/big_left.png" ) );
		images.push_back( GetImage( "maryo/big_right.png" ) );
		// running
		images.push_back( GetImage( "maryo/big_run_left_1.png" ) );
		images.push_back( GetImage( "maryo/big_run_right_1.png" ) );
		// falling
		images.push_back( GetImage( "maryo/big_fall_left.png" ) );
		images.push_back( GetImage( "maryo/big_fall_right.png" ) );
		// jumping
		images.push_back( GetImage( "maryo/big_jump_left.png" ) );
		images.push_back( GetImage( "maryo/big_jump_right.png" ) );
		// dead
		images.push_back( GetImage( "maryo/small_dead_left.png" ) );
		images.push_back( GetImage( "maryo/small_dead_right.png" ) );
		// ducked
		images.push_back( GetImage( "maryo/big_duck_left.png" ) );
		images.push_back( GetImage( "maryo/big_duck_right.png" ) );
		// running 2
		images.push_back( GetImage( "maryo/big_run_left_2.png" ) );
		images.push_back( GetImage( "maryo/big_run_right_2.png" ) );
		// climbing
		images.push_back( GetImage( "maryo/big_climb_left.png" ) );
		images.push_back( GetImage( "maryo/big_climb_right.png" ) );
		/****************************************************/
	}
	else if( maryo_type == MARYO_FIRE )
	{
		/********************* Fire **************************/
		// standing
		images.push_back( GetImage( "maryo/fire_left.png" ) );
		images.push_back( GetImage( "maryo/fire_right.png" ) );
		// running
		images.push_back( GetImage( "maryo/fire_run_left_1.png" ) );
		images.push_back( GetImage( "maryo/fire_run_right_1.png" ) );
		// falling
		images.push_back( GetImage( "maryo/fire_fall_left.png" ) );
		images.push_back( GetImage( "maryo/fire_fall_right.png" ) );
		// jumping
		images.push_back( GetImage( "maryo/fire_jump_left.png" ) );
		images.push_back( GetImage( "maryo/fire_fall_right.png" ) );
		// dead
		images.push_back( GetImage( "maryo/small_dead_left.png" ) );
		images.push_back( GetImage( "maryo/small_dead_right.png" ) );
		// ducked
		images.push_back( GetImage( "maryo/fire_duck_left.png" ) );
		images.push_back( GetImage( "maryo/fire_duck_right.png" ) );
		// running 2
		images.push_back( GetImage( "maryo/fire_run_left_2.png" ) );
		images.push_back( GetImage( "maryo/fire_run_right_2.png" ) );
		// climbing
		images.push_back( GetImage( "maryo/fire_climb_left.png" ) );
		images.push_back( GetImage( "maryo/fire_climb_right.png" ) );
		/****************************************************/
	}
}
...
cFireball :: cFireball( double x, double y, double velocity_x, double velocity_y ) : cSprite ( NULL, x, y )
{
	...
	images.push_back( GetImage( "animation/fireball_1/1.png" ) );
	images.push_back( GetImage( "animation/fireball_1/2.png" ) );
	images.push_back( GetImage( "animation/fireball_1/3.png" ) );
	images.push_back( GetImage( "animation/fireball_1/4.png" ) );
