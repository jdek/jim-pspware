...
cMenuHandler :: cMenuHandler( string logo_filename, string logo_quit_filename, unsigned int posx, unsigned int posy /* = 10  */ )
{
	...
	{
		image_logo = GetImage( logo_filename );
	}

	if( logo_quit_filename.length() )
	{
		image_logo_quit = GetImage( logo_quit_filename );
	}
...
void cMainMenu :: LoadImages( void )
{
	...
	sprintf( filename, "menu/%doptions.png", pPreferences->Screen_W );
	boptions1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%doptions_bw.png", pPreferences->Screen_W );
	boptions2->SetImage( GetImage( filename ), 1 );
	
	sprintf( filename, "menu/%dsave.png", pPreferences->Screen_W );
	bsave1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%dsave_bw.png", pPreferences->Screen_W );
	bsave2->SetImage( GetImage( filename ), 1 );

	sprintf( filename, "menu/%dload.png", pPreferences->Screen_W );
	bload1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%dload_bw.png", pPreferences->Screen_W );
	bload2->SetImage( GetImage( filename ), 1 );
	
	sprintf( filename, "menu/%dquit.png", pPreferences->Screen_W );
	bquit1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%dquit_bw.png", pPreferences->Screen_W );
	bquit2->SetImage( GetImage( filename ), 1 );
	
	sprintf( filename, "menu/%dcontrols.png", pPreferences->Screen_W );
	bcontrols1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%dcontrols_bw.png", pPreferences->Screen_W );
	bcontrols2->SetImage( GetImage( filename ), 1 );

	sprintf( filename, "menu/%daudio.png", pPreferences->Screen_W );
	baudio1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%daudio_bw.png", pPreferences->Screen_W );
	baudio2->SetImage( GetImage( filename ), 1 );

	sprintf( filename, "menu/%dvideo.png", pPreferences->Screen_W );
	bvideo1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%dvideo_bw.png", pPreferences->Screen_W );
	bvideo2->SetImage( GetImage( filename ), 1 );
	
	sprintf( filename, "menu/%don.png", pPreferences->Screen_W );
	bon1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%don_bw.png", pPreferences->Screen_W );
	bon2->SetImage( GetImage( filename ), 1 );

	sprintf( filename, "menu/%doff.png", pPreferences->Screen_W );
	boff1->SetImage( GetImage( filename ), 1 );
	sprintf( filename, "menu/%doff_bw.png", pPreferences->Screen_W );
	boff2->SetImage( GetImage( filename ), 1 );
	
	// Control Items
	// Keyboard
	gamepad->SetImage( GetImage( "menu/items/gamepad.png" ), 1 );
	...
	// Video
	fullscreen->SetImage( GetImage( "menu/items/fullscreen.png" ), 1 );
	...
	// Audio
	music->SetImage( GetImage( "menu/items/music.png" ), 1 );
	sounds->SetImage( GetImage( "menu/items/sounds.png" ), 1 );
